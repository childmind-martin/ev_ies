...
def build_config_row(cfg: Any, *, run_id: str, timestamp_start: str, n_train_cases: int, n_val_cases: int, n_test_cases: int, device: str) -> dict[str, Any]:
    ...
    return {
        ...
        "penalty_ev_export_guard": cfg_values["penalty_ev_export_guard"], "ev_discharge_price_threshold": cfg_values["ev_discharge_price_threshold"], "ev_charge_price_threshold": cfg_values["ev_charge_price_threshold"],
...
def build_training_export_callback(base_callback_cls, *, pd, output_path: Path, step_csv_path: Path, excel_engine: str, config_row: dict[str, Any]):
